 ...
 * Sleep Role Bot
 * -----------------------------------------------------------------------
 * Reacting with TICK_EMOJI on the designated message gives the user the
 * "asleep" role (removing "awake" first if they had it).
 *
 ...
 * that duration tracking survives bot restarts.
 * -----------------------------------------------------------------------
 */
